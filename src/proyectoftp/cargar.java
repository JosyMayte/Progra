...
public class cargar extends Thread {
    ...
    public cargar(JProgressBar progreso, String nombre) {
        super();
    ...
    public void run() {
        try {
            ...
            for (FTPFile file : files) {
                ...
                if (file.getName().equals(nombreArchivo)) { //captura y muestra datos de un archivo especifico
            ...
            File archivoLocal = new File("introduccion" + cont + ".pptx");
            cont++;
